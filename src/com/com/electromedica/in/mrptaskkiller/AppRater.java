...
public class AppRater {
	private final static String APP_TITLE = "AUTO TASK KILLER";
	private final static String APP_PNAME = "com.electromedica.in.mrptaskkiller";
	...
	public static void appLaunched(Context mContext) {
		...
		if (launch_count >= LAUNCHES_UNTIL_PROMPT
				...
				&& System.currentTimeMillis() >= date_firstLaunch
						+ (DAYS_UNTIL_PROMPT * 1 * 60 * 60 * 1000)) {
